...
GO
IF OBJECT_ID('dbo.TournamentRoundTeams', 'U') IS NOT NULL
    DROP TABLE dbo.TournamentRoundTeams;
GO
...
IF OBJECT_ID('dbo.AnnouncementHistoryLogs', 'U') IS NOT NULL
    DROP TABLE dbo.AnnouncementHistoryLogs;
GO
