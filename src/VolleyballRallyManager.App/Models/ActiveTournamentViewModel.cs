...
namespace VolleyballRallyManager.App.Models
{
    public class ActiveTournamentViewModel
    {
        ...
        public Dictionary<TournamentDivision, IEnumerable<TournamentTeamDivision>> TeamsByDivision { get; set; } = new Dictionary<TournamentDivision, IEnumerable<TournamentTeamDivision>>();
    }
}
